...
output_dir = "/home/prpandit/hs_api/tests/output"
...
#create network
# 2b: attach a per-neuron core assignment to every connection to confirm
# the simulator correctly ignores it (core assignment is FPGA/hardware-only).
connections = {k: (v[0], v[1], 5) for k, v in connections.items()}
...
for img, label in test_set:
    ...
    network.simpleSim.initialize_sim_vars(network.simpleSim.numNeurons)
