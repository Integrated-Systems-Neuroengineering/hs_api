"""
LeNet5 with Max-Pooling on MNIST
=================================
This example demonstrates running inference on the MNIST test set using LeNet5,
a convolutional spiking neural network with max-pooling layers, deployed on
HiAER-Spike neuromorphic hardware.

The network processes flattened 28x28 MNIST images as binary spike trains.
Predictions are made by selecting the output neuron with the highest membrane
potential.
"""
...
MODEL_CONFIG_PATH = "LeNet5_config.pkl"
