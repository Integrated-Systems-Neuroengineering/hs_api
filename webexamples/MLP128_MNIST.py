"""
Multi-Layer Perceptron (128 hidden units) on MNIST
===================================================
This example demonstrates running inference on the MNIST test set using a
fully-connected spiking neural network (784-128-10) deployed on HiAER-Spike
...
MODEL_CONFIG_PATH = "MLP128_config.pkl"
