...
def main():
    ...
    axonsDict = {"a0": [("0", 2), ("1", 1)], "a1": [("0", 4), ("1", 3)]}

    neuronsDict = {"0": ([("1", 1)], N1), "1": ([("0", -1)], N2)}
    ...
    visualizing.plot_1d_spikes(
        spikes=sw_s_list.numpy(),
        title="Software Spikes",
    ...
    plot_2d_heatmap(
        array=sw_v_list.numpy(),
        title="Software membrane potentials",
        xlabel="simulating step",
        ylabel="neuron index",
        int_x_ticks=True,
        x_max=args.T,
    ...
    plot_2d_heatmap(
        ...
        title="Hardware membrane potentials",
        xlabel="simulating step",
        ylabel="neuron index",
        int_x_ticks=True,
        x_max=args.T,
