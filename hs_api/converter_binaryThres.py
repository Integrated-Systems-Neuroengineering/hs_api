...
#removed all attention functions
#removed the try, catch block in the linear_converter function
#removed embed_dim in CRI_converter
#replaced all LIF_neuron with ANN_neuron
#changed dynamic alpha to the max value of tensor instead of max - min value
#removed quantization for LIF layer
#removed sparse_converter
