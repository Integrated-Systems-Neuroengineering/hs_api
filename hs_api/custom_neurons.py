...
#Defualt IFNode but with > thresholding instead of >= thresholding
...
#Same as LIFNode, but order of operations for the neuron is changed to match the converter's order
