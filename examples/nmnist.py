...
def main():
    ...
    parser.add_argument(
        "-convert", action="store_true", help="Convert the network for CRI"
    )

    args = parser.parse_args()
    print(args)

    net = parametric_lif_net.NMNISTNet(
    ...
    if args.convert:
        ...
        input_layer = (
            0  # first pytorch layer that acts as synapses, indexing begins at 0
        )
